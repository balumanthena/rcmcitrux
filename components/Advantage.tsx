...
export default function AdvantagesSection() {
  return (
    <section className="relative py-20 font-sans" style={{ backgroundColor: bgDark }}>
      <div className="container mx-auto px-4">
        {/* Heading */}
        <h2 className="text-center text-4xl font-extrabold text-primary mb-3 tracking-tight">
