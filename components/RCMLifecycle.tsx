  ...
  return (
    <section className="py-16 px-6 bg-gradient-to-b from-white to-slate-50">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 p-4 items-start">
        {isMobile ? (
          // === MOBILE VIEW: Vertical List + Details ===
          <div className="w-full space-y-6">
            ...
            <div className="flex flex-col gap-4">
              {STAGES.map((s, i) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-12 h-12 rounded-lg flex items-center justify-center bg-gradient-to-br ${s.color} text-white shadow`}
                    >
            ...
            <div className="bg-white/60 backdrop-blur-md border border-white/40 rounded-3xl p-6 shadow-md">
              <div className="flex items-center gap-5">
                <div
                  className={`w-16 h-16 rounded-lg flex items-center justify-center bg-gradient-to-br ${STAGES[selected].color} text-white shadow`}
                >
          ...
          // === DESKTOP VIEW: Circle + Details side-by-side ===
          <>
            {/* Circle */}
